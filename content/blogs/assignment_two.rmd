...
draft: false
image: bike.jpeg # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work
...
```{r, echo=FALSE}
knitr::include_graphics("/img/blogs/bike.JPG",error =FALSE)
```
