...
draft: false
image: DJIA.jpeg # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work
...
```{r, echo=FALSE}
knitr::include_graphics("/img/blogs/DJIA.JPG",error =FALSE)
```
